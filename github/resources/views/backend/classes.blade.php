                    ...
                    <div class="card-body p-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="branch">
                                    ...
                                    <option value="C-TM">C-TM</option>
                                    <option value="A-TM">A-TM</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="department">
                                    ...
                                    <option value="Alansız">Alansız</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tur">
                                    ...
                                    <option value="A">Anadolu</option>
                                    <option value="F">FenTek</option>
                                  </select>
                                {{-- <input type="text" class="form-control" id="department" placeholder="Örn: Bilişim Teknolojileri"> --}}
                            </div>
